-- ripperdoc-devicedb schema
-- Canonical online boards database.
-- v2 entity tables (mirror of Board Database/create_mockup_db.sql) PLUS five
-- new tables from spec §4 for the contribution + token + audit machinery.
--
-- Schema is applied idempotently on boot via internal/schema/migrate.go.
...
-- ============================================================
-- Reference palette (v2 entity tables)
-- ============================================================
