...
INSERT INTO boards (brand, model, model_number, board_number, board_name, odm, board_number_type, source, source_url)
VALUES ('Lenovo', 'ThinkPad T450', '20BU/20BX', 'NM-A251', 'AIVL0', 'LCFC', 'lenovo_nm', 'boardschematic', 'https://boardschematic.com/lenovo-thinkpad-t450-uma-gpu-schematic-aivl0-nm-a251/');
...
INSERT INTO boards (brand, model, model_number, board_number, board_name, odm, board_number_type, source, source_url)
VALUES ('Apple', 'MacBook Air 13" M1 Late 2020', 'A2337', '820-02016-A', 'X1757', 'Apple', 'apple_820', 'logiwiki', 'https://logi.wiki/index.php/Board_Number_by_A_Number');
...
INSERT INTO boards (brand, model, model_number, board_number, board_name, odm, board_number_type, source, source_url)
VALUES ('Dell', 'Inspiron 17R 5720', 'N5720', 'DA0R09MB6H1', 'Quanta R09', 'Quanta', 'quanta_da0', 'ebay', 'https://www.ebay.com/p/1981179302');
