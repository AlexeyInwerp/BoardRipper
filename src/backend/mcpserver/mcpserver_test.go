...
func TestServer_ListToolsIncludesLive(t *testing.T) {
	...
	want := map[string]bool{"ping": false, "board_active": false, "net_neighbors": false, "highlight_net": false, "selected_part": false, "board_tabs": false, "switch_tab": false, "open_file": false}
