...
export const SETTINGS_INDEX: IndexEntry[] = [
  ...
  F('board', 'pins', 'showNetNames', 'Show Net Names', 'Display the net name on each pin (GND and NC are excluded — already colour-coded). Turn off to unclutter dense parts, or to leave the pin free for diode readings', ['net', 'net name', 'label', 'signal', 'declutter']),
